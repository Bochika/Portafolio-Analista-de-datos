# ESTE ES UN PROGRAMA DISEÑADO PARA PODER DEMOSTRAR LA FRACTALIDAD EN ALGUNAS PLANTAS EN UN CONGRSO DE BOTÁNICA Y MATEMÁTICAS EN EL 
# JARDÍN BOTÁNICO JOSE CELESTINO MUTIS EN BOGOTÁ EN MI CONFERENCIA LLAMADA GEOMETRÍA VIVA (FRACTALES EN MOVIMIENTO) 


![Espiral](imagenes/espiral.png)

# PARA VER EL PROGRAMA HAY QUE CORRER EL SIGUIENTE CÓDIGO
